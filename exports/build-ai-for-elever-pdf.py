#!/usr/bin/env python3
"""Regenerate the A4 PDFs for the 'Should students use AI?' guide (SV + EN).

Dark-covered guides get a two-pass render:
  - Cover (page 1): footer with the title only, in white, no page number.
  - Pages 2+: standard grey footer with title + page number.
Then merged into a single PDF via pypdf.
"""
import os
import tempfile
