#!/usr/bin/env python3
"""Build the Claude full-guide PDFs (EN + SV) from HTML sources.

Idempotent: renders exports/claude-print-a4-{en,sv}.html to PDF, then
appends the CC BY-NC-SA 4.0 license page (from
exports/claude-guide-license-{en,sv}.html) as the final page of each.
...
Run:
  ...
  python3 exports/build-claude-pdf.py
"""
...
pdf_out_dir = root / "assets/pdfs/guides"
pdf_out_dir.mkdir(parents=True, exist_ok=True)

jobs = [
    {
        "lang": "en",
        "main_html": root / "exports/claude-print-a4-en.html",
        "license_html": root / "exports/claude-guide-license-en.html",
        "final_pdf": pdf_out_dir / "claude-guide-en.pdf",
    },
    {
        "lang": "sv",
        "main_html": root / "exports/claude-print-a4-sv.html",
        "license_html": root / "exports/claude-guide-license-sv.html",
        "final_pdf": pdf_out_dir / "claude-guide-sv.pdf",
    },
]


def render_pdf(page, html_path: Path, pdf_path: Path) -> None:
    """Render one HTML file to one PDF via Playwright."""
...
with sync_playwright() as p:
    ...
    for job in jobs:
        ...
        # 2. Render the license page to another temp PDF (if source exists).
        license_tmp = None
